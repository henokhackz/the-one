...
const ProfilePage = () => {
  return (
    <div className="min-h-screen pt-40 pb-20 px-6 mx-auto space-y-32">
      {/* 1. IDENTITY BLOCK */}
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-4">
            <h1 className="text-6xl md:text-8xl font-black text-white/90 tracking-tighter uppercase leading-none">
              DIGITAL
              <br />
              <span className="text-green-500/80">ARCHITECT</span>
            </h1>
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-xl font-light italic">
            "Engineering the intersection of high-frequency performance and
            futuristic aesthetics. Currently optimizing for elite remote
            missions and complex freelance architectures."
          </p>
        ...
        <div className="relative group">
          ...
          <div className="relative border border-white/10 p-2  backdrop-blur-3xl aspect-[4/5] flex items-center justify-center overflow-hidden rounded-2xl">
            ...
            <div className="w-full h-full bg-white/[0.02] flex flex-col items-center justify-center relative">
              <div className="text-[120px] font-black text-white/5 select-none tracking-tighter">
                LB
              </div>
              <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center space-y-6 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                ...
                <p className="text-[11px] font-mono text-green-500/60 leading-relaxed uppercase tracking-widest">
                  // DATA_LOG: Lantumo Birhanu
                  <br />
                  // ORIGIN: Addis Ababa
                  <br />
                  // STACK: JS/TS/React/Node/AI
                  <br />
                  // MISSION: Excellence
                </p>
              </div>
              <div className="absolute bottom-6 left-6 right-6 border-t border-white/10 pt-4 flex justify-between items-center">
                <div className="flex gap-2">
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={i}
                      className="w-1 h-1 bg-green-500/40 rounded-full animate-pulse"
      ...
      <section className="pt-20 border-t border-white/5">
        <div className="mb-12 text-center space-y-2">
          <h3 className="text-[10px] font-mono text-green-500/60 uppercase tracking-[0.5em]">
            Global_Readiness_Report
          </h3>
          <p className="text-white/20 text-[9px] uppercase tracking-widest italic">
            Updated_In_Real_Time
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={i}
              className="p-8 border border-white/5 bg-white/[0.01] hover:bg-green-500/[0.02] hover:border-green-500/20 transition-all flex flex-col items-center text-center gap-4 group"
            >
              <stat.icon className="w-6 h-6 text-white/20 group-hover:text-green-500/60 transition-colors" />
              <div className="space-y-1">
                <div className="text-xl font-black text-white group-hover:text-green-500 transition-colors">
                  {stat.val}
                </div>
