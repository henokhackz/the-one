...
const ServiceCard = ({ title, description }: ServiceCardProps) => (
  <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-md p-6 mb-6 text-white transition duration-300 hover:scale-[1.02]">
  ...
  return (
    <div className={cn("sticky top-20 z-10", className)}>
      <div className="relative flex flex-col md:flex-row items-center justify-between gap-4 lg:gap-12  w-full px-4 md:px-16">
        ...
        <div className="relative w-full md:w-1/2  -top-10">
          <svg
          ...
          <Image
            ...
            width={200}
            alt="Center"
            className="absolute top-1/2 left-1/2 w-32 h-32 md:w-40 md:h-40 object-cover rounded-full shadow-lg border border-white/20 -translate-x-1/2 -translate-y-1/3 grayscale"
          />
        </div>
