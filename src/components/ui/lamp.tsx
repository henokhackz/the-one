  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-blue-500/20 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "32rem" }}
          whileInView={{ width: "64rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
          }}
          className="absolute  inset-auto z-30 h-64 w-[80vh] -translate-y-[6rem] rounded-full bg-blue-400/20   blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "30rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[80rem] -translate-y-[7rem] bg-blue-400/20 "
        ></motion.div>
