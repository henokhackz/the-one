  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col items-center mb-20">
          ...
          >
            ...
            <p className="mt-4 text-sm text-muted max-w-lg leading-relaxed">
              Academic foundation and continuous learning paths focused on
              advancing modern software engineering capabilities.
            </p>
          </motion.div>
        </div>
        ...
        >
          <div
            className="flex flex-col md:flex-row w-full items-center bg-surface border border-border p-8 md:p-10 relative overflow-hidden transition-all duration-500 hover:border-emerald-500/40"
          ...
          >
            ...
            />
            <div
              className="absolute top-0 right-0 w-16 h-px pointer-events-none"
              style={{
                background: `linear-gradient(to left, ${accent}50, transparent)`,
              }}
            />

            <div className="flex-shrink-0 relative w-32 h-32 md:w-40 md:h-40 flex items-center justify-center border border-border overflow-hidden mb-8 md:mb-0 group-hover:border-emerald-500/30 transition-colors duration-500">
            ...
            <div className="flex flex-col justify-center border-l md:border-l-white/10 md:border-t-0 border-t border-border pl-0 md:pl-10 pt-8 md:pt-0 w-full">
              ...
              <h3 className="text-3xl font-bold text-foreground tracking-wide mb-2 group-hover:text-emerald-50 transition-colors">
                {educationData.university.name}
              </h3>
              <p className="text-muted text-[11px] font-mono tracking-[0.2em] uppercase mb-5">
                {educationData.university.degree}
              </p>
              <p className="text-muted leading-relaxed text-[0.9rem] max-w-xl">
...
function CourseCard({ course, accent }: { course: any; accent: string }) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col h-full bg-surface transition-all duration-500 overflow-hidden"
      style={{
    ...
    >
      ...
      />
      <div
        className="absolute top-0 right-0 w-px h-12 pointer-events-none z-20"
        style={{
          background: `linear-gradient(to bottom, ${hovered ? accent : "transparent"}60, transparent)`,
        }}
      />
      <div
        className="absolute top-0 right-0 w-12 h-px pointer-events-none z-20"
        style={{
          background: `linear-gradient(to left, ${hovered ? accent : "transparent"}60, transparent)`,
        }}
      />
      ...
      <div className="p-6 flex flex-col flex-grow justify-between relative bg-gradient-to-b from-transparent to-white/[0.01]">
        <div>
          <div className="flex items-center gap-2 mb-3">
            <span className="px-2 py-0.5 border border-border text-muted text-[8px] font-mono uppercase tracking-[0.2em] bg-foreground rounded-sm">
              {course.provider}
            </span>
          ...
          <h4 className="text-base font-bold text-muted tracking-wide leading-snug group-hover:text-emerald-400 transition-colors">
            {course.title}
          </h4>
        </div>

        <div className="mt-6 flex items-center text-[9px] font-mono uppercase tracking-[0.2em] text-muted group-hover:text-muted transition-colors">
